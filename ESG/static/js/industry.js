...
function build_industrytop10_plot() {
    ...
    d3.json("/ESG_Industry10_Table.json").then((data) => {
...
function build_Environment_industrytop10_plot() {
    ...
    d3.json("/E_Industry10_Table.json").then((data) => {
        // log the data in order to visualize it
        console.log(data);
...
function build_Social_industrytop10_plot() {
    ...
    d3.json("/S_Industry10_Table.json").then((data1) => {
        // log the data in order to visualize it
        console.log(data1);
...
function build_Governance_industrytop10_plot() {
    ...
    d3.json("/G_Industry10_Table.json").then((data) => {
        // log the data in order to visualize it
        console.log(data);
...
function build_industry_dynamic_plot(industry_name) {
    ...
    d3.json("/ESG_Industry_Table.json").then((data) => {
        // log the data in order to visualize it
        console.log(data);
